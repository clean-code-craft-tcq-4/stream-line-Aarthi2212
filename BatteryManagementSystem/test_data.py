...
readings_configuration = [
    {
        TOTAL_READINGS_TO_READ: 70,
        TOTAL_EXPECTED_READINGS: 70
    },
    {
        TOTAL_READINGS_TO_READ: 20,
        TOTAL_EXPECTED_READINGS: 20
    },
    {
        TOTAL_READINGS_TO_READ: None,
        TOTAL_EXPECTED_READINGS: DEFAULT_NO_OF_READINGS
    },
    {
        TOTAL_READINGS_TO_READ: -10,
        TOTAL_EXPECTED_READINGS: DEFAULT_NO_OF_READINGS
    },
    {
...
validate_send_data = [
    {
        TOTAL_READINGS_TO_READ: DEFAULT_NO_OF_READINGS,
        TOTAL_EXPECTED_READINGS: DEFAULT_NO_OF_READINGS
    },
    {
        TOTAL_READINGS_TO_READ: 0,
        TOTAL_EXPECTED_READINGS: DEFAULT_NO_OF_READINGS
    },
    {
        TOTAL_READINGS_TO_READ: 100,
